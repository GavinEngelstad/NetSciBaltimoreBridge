...
def shortest_average_path(G: nx.Graph,
    ...
    G = G.subgraph(max(nx.strongly_connected_components(G), key=len)) # average_shortest_path_length only works on strongly connected graphs
...
def merge_centralities():
    ...
    # save
    network_stats.to_csv('data/network_stats/network_stats.csv', index=False) # save node stats
    avg_spath.to_csv(f'data/network_stats/avg_spath.csv', index=False) # save average path

    os.remove('data/network_stats/betweenness_w_bridge.csv') # remove unneeded files
    os.remove('data/network_stats/betweenness_wo_bridge.csv')
    os.remove('data/network_stats/closeness_w_bridge.csv')
    os.remove('data/network_stats/closeness_wo_bridge.csv')
    os.remove('data/network_stats/eigenvector_w_bridge.csv')
    os.remove('data/network_stats/eigenvector_wo_bridge.csv')
    os.remove('data/network_stats/straightness_w_bridge.csv')
    os.remove('data/network_stats/straightness_wo_bridge.csv')
    os.remove('data/network_stats/avg_spath_w_bridge.csv')
    os.remove('data/network_stats/avg_spath_wo_bridge.csv')
...
def main():
    ...
    strcent_w_bridge_p = Process(target=straightness_centrality, args=(intersections_df, roads_G, 3, False))
    ...
    strcent_wo_bridge_p = Process(target=straightness_centrality, args=(intersections_df, roads_wo_bridge_G, 3, True))
