...
def main():
    ...
    intersections_gdf = gdfs[0].to_crs('EPSG:2893') # nodes
    roads_gdf = gdfs[1].to_crs('EPSG:2893') # edges
    ...
    intersections_gdf.to_csv('data/network/BMA_intersections.csv')
    roads_gdf.to_csv('data/network/BMA_roads.csv')
